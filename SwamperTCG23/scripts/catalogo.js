// Datos de las cartas del catálogo.
// Para agregar una carta nueva, solo hay que añadir un objeto más a este arreglo.
let cartas = [
  {
    id: 1,
...
// Rellena el div#catalogo de catalogo.html con todas las cartas del arreglo.
  ...
  for (const carta of cartasAMostrar) {
    contenedor.innerHTML += `
      <div class="caluga-carta-catalogo">
        <a href="/paginas/carta1.html?id=${carta.id}">
...
// Lee el "id" de la URL y rellena el div#carta de carta1.html con el detalle.
